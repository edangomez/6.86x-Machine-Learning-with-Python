...
def epsilon_greedy(state_vector, theta, epsilon):
    ...
    if np.random.random() < epsilon:
        ...
        q_func = theta @ state_vector
        action_index, object_index = index2tuple(q_func.argmax())
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        if for_training:
            # update Q-function.
            # TODO Your code here
            linear_q_learning(theta, current_state_vector, action_index, object_index, reward,
    ...
    #     # Choose next action and execute
    #     # TODO Your code here
    #     current_room_i, current_quest_i = dict_room_desc[current_room_desc], dict_quest_desc[current_quest_desc]
    #     action_index, object_index = epsilon_greedy(current_room_i, current_quest_i, q_func, epsilon)
    #     next_room_desc, next_quest_desc, reward, terminal = framework.step_game(current_room_desc, current_quest_desc,
    #                                                                             action_index, object_index)
    #     next_room_i, next_quest_i = dict_room_desc[next_room_desc], dict_quest_desc[next_quest_desc]
    #
    #     if for_training:
    #         # update Q-function.
    #         tabular_q_learning(q_func, current_room_i, current_quest_i, action_index, object_index, reward, next_room_i,
    #                            next_quest_i, terminal)
    #         pass
    #
    #     if not for_training:
    #         # update reward
    #         # TODO Your code here
    #         epi_reward = epi_reward + reward * GAMMA ** (framework.STEP_COUNT - 1)
    #         pass
    #
    #     # prepare next step
    #     # TODO Your code here
