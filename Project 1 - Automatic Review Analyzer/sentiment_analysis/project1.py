...
def pegasos(feature_matrix, labels, T, L):
    ...
    for t in range(T):
        ...
        for i in get_order(feature_matrix.shape[0]):
            ...
            t_ += 1
            eta = 1 / np.sqrt(t_)
            t = pegasos_single_step_update(feature_matrix[i, :], labels[i], L, eta, theta, theta_0)
            theta, theta_0 = t[0], t[1]
            # pass
    return (theta, theta_0)
    #raise NotImplementedError
...
def classifier_accuracy(
    ...
    """
    # Your code here
    #pegasos(train_feature_matrix, train_labels, 10, 0.2)
    theta, theta_0 = classifier(train_feature_matrix, train_labels, **kwargs)
    t_preds = classify(train_feature_matrix, theta,theta_0)
    v_preds = classify(val_feature_matrix, theta,theta_0)

    return accuracy(t_preds, train_labels), accuracy(v_preds, val_labels)
...
def bag_of_words(texts):
    ...
    no_words = load_words('stopwords.txt')
