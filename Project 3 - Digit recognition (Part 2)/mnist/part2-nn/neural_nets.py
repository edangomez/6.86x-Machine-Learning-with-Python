...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        output = self.hidden_to_output_weights @ hidden_layer_activation  # TODO (1,1) u1 = f(z1)*V11 + f(z1)*V21 + f(z1)*V31
        ...
        hidden_layer_error = np.multiply(np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input), self.hidden_to_output_weights.T) * output_layer_error  # TODO (3,1)
